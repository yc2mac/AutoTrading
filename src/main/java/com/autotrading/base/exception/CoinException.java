...
public class CoinException extends RuntimeException {
         ...
         *            消息是否为属性文件中的Key
         */
        public CoinException(String errorCode, String message, boolean propertiesKey)
        {
            super(message);
         ...
         *            信息描述
         */
        public CoinException(String errorCode, String message, Throwable cause, boolean propertiesKey)
        {
            super(message, cause);
            this.setErrorCode(errorCode);
            this.setPropertiesKey(propertiesKey);
